  ...
  closeModal();
    ...
    return (
        <div className="overflow-x-auto">
               ...
               <button className="bg-blue-500 hover:bg-blue-600 text-white py-1 px-2 rounded mr-2 mb-2">Add New</button> 
                </Link>
                    ...
                    <tbody className='text-center'>
                        {wallets?.map((wallet, index) => (
                            <tr key={wallet.id}>
                                ...
                                <td className="py-2 px-4 border-b">{wallet.wallet_address.slice(0,10)}..</td>
                                ...
                                <td className="py-2 px-4 border-b">
                                  ...
                                  >
                                    ...
                                    <button onClick={()=>openModal(wallet.id)} className="bg-red-500 hover:bg-red-600 text-white py-1 px-2 rounded">
                                        Delete
                                    </button>
                                </td>
                            </tr>
