      ...
      <div className="account">
        ...
        <div className="wallet_select">
          <div className="title">
            ...
            <div className="value fs-26 fc-5B616E ff_NunitoSemiBold">Select a wallet</div>
        ...
        {filteredWallets.length > 0 && (
          <div className="wallet_list">
            {filteredWallets.map((wallet) => (
              <a href={`funds?coin=${wallet.post_name}`} key={wallet.id} className="wallet_item">
                <div className="item_info">
                  ...
                  <div className="info">
                    <div className="fs-32 fc-353F52 ff_NunitoBold">{wallet.coin_symbol} Wallet</div>
                    <div className="subtitle fs-26 fc-5B616E ff_NunitoSemiBold">{wallet.coin_symbol} Coin</div>
                  </div>
                </div>
